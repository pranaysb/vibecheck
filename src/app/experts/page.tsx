  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="max-w-3xl space-y-3">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-white font-sans tracking-tight font-semibold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-5 rounded-2xl border border-white/[0.08] bg-[#0c0c0e] space-y-1.5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)]">
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-bold text-white tracking-tight">Available Verified Engineers</h2>
