...
import { AuditFinding, SelfAuditReport } from "@/lib/audit/self-audit-engine";

interface SelfAuditClientViewProps {
  initialReport: SelfAuditReport;
}

export default function SelfAuditClientView({ initialReport }: SelfAuditClientViewProps) {
  const [report, setReport] = useState<SelfAuditReport>(initialReport);
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900 pb-20 font-sans">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-8 space-y-8">
        ...
        {/* Reproducible Findings & Remediation Log */}
