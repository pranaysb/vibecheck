  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
      ...
      <div className="space-y-4">
        ...
        <h1 className="text-3xl sm:text-5xl font-black text-slate-100 font-sans tracking-tight">
          Don't just vibe code. <span className="text-emerald-400">Vibe check.</span>
        </h1>
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-bold text-slate-100 border-b border-white/5 pb-3">
      ...
      {/* The Core Loop */}
      <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-8 space-y-6">
        <h2 className="text-xl font-bold text-slate-100">The VibeCheck Solution</h2>
        ...
        <div className="space-y-3 text-xs">
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong className="text-slate-200">Automated Static & Remote Safety Analysis:</strong>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong className="text-slate-200">Structured Community Reviews:</strong>
              <p className="text-slate-400 mt-0.5 leading-relaxed">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong className="text-slate-200">Verified Expert Marketplace:</strong>
              <p className="text-slate-400 mt-0.5 leading-relaxed">
      ...
      <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400">Join the next generation of verified builders.</p>
        </div>
        <Link
          href="/projects/new"
