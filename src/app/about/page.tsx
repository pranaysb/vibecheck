    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
      ...
      <div className="space-y-4">
        ...
        <h1 className="text-3xl sm:text-5xl font-semibold text-white font-sans tracking-tight">
          Don't just vibe code. <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-400">Vibe check.</span>
        </h1>
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-semibold text-white border-b border-white/[0.06] pb-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="p-5 rounded-2xl border border-white/[0.08] bg-[#0c0c0e] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] space-y-1.5">
      ...
      {/* The Core Loop */}
      <div className="rounded-2xl border border-white/[0.08] bg-[#0c0c0e] p-8 space-y-6 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)]">
        <h2 className="text-xl font-semibold text-white">The VibeCheck Solution</h2>
        ...
        <div className="space-y-3 text-xs">
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong className="text-white">Automated Static & Remote Safety Analysis:</strong>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong className="text-white">Structured Community Reviews:</strong>
              <p className="text-zinc-400 mt-0.5 leading-relaxed">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong className="text-white">Verified Expert Marketplace:</strong>
              <p className="text-zinc-400 mt-0.5 leading-relaxed">
      ...
      <div className="pt-6 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-400">Join the next generation of verified builders.</p>
        </div>
        <Link
          href="/projects/new"
