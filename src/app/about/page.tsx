  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
      ...
      <div className="space-y-4">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-indigo-200 bg-indigo-50 text-indigo-700 text-xs font-mono font-medium">
      ...
      {/* The Core Loop */}
      <div className="rounded-2xl border border-slate-200 bg-white p-8 space-y-6 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)]">
